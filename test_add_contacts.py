...
class UntitledTestCase ( unittest.TestCase ):
    ...
    def add_contact(self, wd, group ):
        ...
        wd.find_element_by_name ( "title" ).send_keys ( group.titile )
        wd.find_element_by_name ( "company" ).click ()
        wd.find_element_by_name ( "company" ).clear ()
        wd.find_element_by_name ( "company" ).send_keys ( group.compony )
    ...
    def test_add_contact(self):
        ...
        self.add_contact ( wd , Group(firstname = 'anna',middlename = ' alex',
    ...
    def test_add_empty_contact(self):
        ...
        self.open_home_page ( wd )
        self.login (wd, username="admin", password="secret" )
        self.add_contact ( wd, Group(firstname = '',middlename='',
